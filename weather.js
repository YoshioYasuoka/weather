$(function() {
  var handleWeatherResponse = function(data) {
    ...
    var markup = "<p>The current weather condition is " + data.currently.icon + ", " + data.currently.apparentTemperature + "°F.</p>" + "<p> The 3-day daily forecast is " + data.daily.summary + "</p>";
